    ...
    <div className="app-shell" style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div className="modal" style={{ maxWidth: "420px", width: "100%", padding: "36px", background: "var(--bg-elevated)", border: "1px solid var(--border-default)" }}>
        <div style={{ textAlign: "center", marginBottom: "28px" }}>
          ...
          <h1 className="modal-title" style={{ fontSize: "22px", marginBottom: "6px", textAlign: "center" }}>Create Account</h1>
          <p className="modal-subtitle">Start tracking your blocked commitments in QueueFlow</p>
        </div>
